...
- [x] **Sovereign Python Siphon**: Native distribution of 889+ skills (No Node/NPX required!) - v1.0.2.
- **`skillsmith add --remote awesome`**: Install any skill directly from the sovereign repository.
