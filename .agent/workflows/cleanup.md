...
**Objectives**:
- Read .agent/project_profile.yaml and .agent/context/project-context.md before taking action.
- Confirm the project stage, app type, frameworks, and priorities for goal: cleanup obsolete code and artifacts for library click, pytest, arch-business-logic, arch-ui, arch-unknown.
- Top relevant skills: notebooklm, loki_mode, terraform_module_library, javascript_testing_patterns, makepad_skills.
...
10. Load the top relevant skills: notebooklm, loki_mode, terraform_module_library, javascript_testing_patterns, makepad_skills.
