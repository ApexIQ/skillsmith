...
- **Goal**: review changes for library click, pytest, arch-business-logic, arch-ui, arch-unknown
...
- **Skills**: notebooklm, loki_mode, javascript_testing_patterns, makepad_skills, architect_review
...
**Objectives**:
- Read .agent/project_profile.yaml and .agent/context/project-context.md before taking action.
- Confirm the project stage, app type, frameworks, and priorities for goal: review changes for library click, pytest, arch-business-logic, arch-ui, arch-unknown.
- Top relevant skills: notebooklm, loki_mode, javascript_testing_patterns, makepad_skills, architect_review.
