...
- **Skills**: notebooklm, terraform_module_library, javascript_testing_patterns, loki_mode, temporal_python_testing
...
**Objectives**:
- Read .agent/project_profile.yaml and .agent/context/project-context.md before taking action.
- Confirm the project stage, app type, frameworks, and priorities for goal: bootstrap a new module or service for library click, pytest, arch-business-logic, arch-ui, arch-unknown.
- Top relevant skills: notebooklm, terraform_module_library, javascript_testing_patterns, loki_mode, temporal_python_testing.
...
10. Load the top relevant skills: notebooklm, terraform_module_library, javascript_testing_patterns, loki_mode, temporal_python_testing.
