...
- **Goal**: debug complex runtime issues for library click, pytest, arch-business-logic, arch-ui, arch-unknown
...
- **Skills**: notebooklm, javascript_testing_patterns, makepad_skills, context7_auto_research, typescript_expert
...
**Objectives**:
- Read .agent/project_profile.yaml and .agent/context/project-context.md before taking action.
- Confirm the project stage, app type, frameworks, and priorities for goal: debug complex runtime issues for library click, pytest, arch-business-logic, arch-ui, arch-unknown.
- Top relevant skills: notebooklm, javascript_testing_patterns, makepad_skills, context7_auto_research, typescript_expert.
...
**Acceptance Checks**:
- [ ] Reproduce the issue and capture the failing behavior before the fix is applied.
- [ ] Implement the fix with focused verification for the affected area.
