...
- **Goal**: search and research repository for library click, pytest, arch-business-logic, arch-ui, arch-unknown
...
- **Skills**: notebooklm, javascript_testing_patterns, makepad_skills, reverse_engineer, context7_auto_research
...
**Objectives**:
- Read .agent/project_profile.yaml and .agent/context/project-context.md before taking action.
- Confirm the project stage, app type, frameworks, and priorities for goal: search and research repository for library click, pytest, arch-business-logic, arch-ui, arch-unknown.
- Top relevant skills: notebooklm, javascript_testing_patterns, makepad_skills, reverse_engineer, context7_auto_research.
...
10. Load the top relevant skills: notebooklm, javascript_testing_patterns, makepad_skills, reverse_engineer, context7_auto_research.
