...
- **Goal**: deploy release checklist for library click, pytest, arch-business-logic, arch-ui, arch-unknown
...
- **Skills**: notebooklm, javascript_testing_patterns, makepad_skills, context7_auto_research, loki_mode
...
**Objectives**:
- Read .agent/project_profile.yaml and .agent/context/project-context.md before taking action.
- Confirm the project stage, app type, frameworks, and priorities for goal: deploy release checklist for library click, pytest, arch-business-logic, arch-ui, arch-unknown.
- Top relevant skills: notebooklm, javascript_testing_patterns, makepad_skills, context7_auto_research, loki_mode.
...
- [ ] rollback notes or release checklist items are explicitly named.
...
8. [AND] Ship stage: Check release readiness against the current project stage, priorities, and target tools. Acceptance: The generated workflow includes both stage structure and the legacy `steps` list.; rollback notes or release checklist items are explicitly named..
...
10. Load the top relevant skills: notebooklm, javascript_testing_patterns, makepad_skills, context7_auto_research, loki_mode.
