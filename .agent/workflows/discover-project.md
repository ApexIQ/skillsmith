...
- **Goal**: discover project context library click, pytest, arch-business-logic, arch-ui, arch-unknown
...
- **Skills**: notebooklm, temporal_python_testing, core_components, javascript_testing_patterns, n8n_code_python
...
**Objectives**:
- Read .agent/project_profile.yaml and .agent/context/project-context.md before taking action.
- Confirm the project stage, app type, frameworks, and priorities for goal: discover project context library click, pytest, arch-business-logic, arch-ui, arch-unknown.
- Top relevant skills: notebooklm, temporal_python_testing, core_components, javascript_testing_patterns, n8n_code_python.
...
10. Load the top relevant skills: notebooklm, temporal_python_testing, core_components, javascript_testing_patterns, n8n_code_python.
