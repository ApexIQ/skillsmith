...
**Objectives**:
- Read .agent/project_profile.yaml and .agent/context/project-context.md before taking action.
- Confirm the project stage, app type, frameworks, and priorities for goal: test and verify implementation for library click, pytest, arch-business-logic, arch-ui, arch-unknown.
