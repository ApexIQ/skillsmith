...
- **Goal**: plan and execute migration for library click, pytest, arch-business-logic, arch-ui, arch-unknown
...
**Objectives**:
- Read .agent/project_profile.yaml and .agent/context/project-context.md before taking action.
- Confirm the project stage, app type, frameworks, and priorities for goal: plan and execute migration for library click, pytest, arch-business-logic, arch-ui, arch-unknown.
