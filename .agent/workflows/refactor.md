...
- **Goal**: refactor project structure and technical debt for library click, pytest, arch-business-logic, arch-ui, arch-unknown
...
**Objectives**:
- Read .agent/project_profile.yaml and .agent/context/project-context.md before taking action.
- Confirm the project stage, app type, frameworks, and priorities for goal: refactor project structure and technical debt for library click, pytest, arch-business-logic, arch-ui, arch-unknown.
- Top relevant skills: notebooklm, javascript_testing_patterns, makepad_skills, uv_package_manager, loki_mode.
...
10. Load the top relevant skills: notebooklm, javascript_testing_patterns, makepad_skills, uv_package_manager, loki_mode.
