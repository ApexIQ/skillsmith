...
- **Goal**: compose multiple skills and workflows for library click, pytest, arch-business-logic, arch-ui, arch-unknown
...
- **Skills**: javascript_testing_patterns, makepad_skills, notebooklm, temporal_python_testing, zapier_make_patterns
...
**Objectives**:
- Read .agent/project_profile.yaml and .agent/context/project-context.md before taking action.
- Confirm the project stage, app type, frameworks, and priorities for goal: compose multiple skills and workflows for library click, pytest, arch-business-logic, arch-ui, arch-unknown.
- Top relevant skills: javascript_testing_patterns, makepad_skills, notebooklm, temporal_python_testing, zapier_make_patterns.
