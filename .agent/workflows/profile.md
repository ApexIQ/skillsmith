...
- **Goal**: inspect and tune the project profile for library click, pytest
...
**Objectives**:
- Read .agent/project_profile.yaml and .agent/context/project-context.md before taking action.
- Confirm the project stage, app type, frameworks, and priorities for goal: inspect and tune the project profile for library click, pytest.
