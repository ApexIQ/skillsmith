...
- **Goal**: inspect and tune the project profile for library click, pytest, arch-business-logic, arch-ui, arch-unknown
...
- **Skills**: notebooklm, uv_package_manager, core_components, javascript_testing_patterns, makepad_skills
...
**Objectives**:
- Read .agent/project_profile.yaml and .agent/context/project-context.md before taking action.
- Confirm the project stage, app type, frameworks, and priorities for goal: inspect and tune the project profile for library click, pytest, arch-business-logic, arch-ui, arch-unknown.
- Top relevant skills: notebooklm, uv_package_manager, core_components, javascript_testing_patterns, makepad_skills.
...
10. Load the top relevant skills: notebooklm, uv_package_manager, core_components, javascript_testing_patterns, makepad_skills.
