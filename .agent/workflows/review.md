...
- **Skills**: notebooklm, loki_mode, architect_review, terraform_module_library, javascript_testing_patterns
...
**Objectives**:
- Read .agent/project_profile.yaml and .agent/context/project-context.md before taking action.
- Confirm the project stage, app type, frameworks, and priorities for goal: review code and architecture for library click, pytest, arch-business-logic, arch-ui, arch-unknown.
- Top relevant skills: notebooklm, loki_mode, architect_review, terraform_module_library, javascript_testing_patterns.
...
10. Load the top relevant skills: notebooklm, loki_mode, architect_review, terraform_module_library, javascript_testing_patterns.
