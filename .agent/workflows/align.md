...
- **Goal**: align project instructions and rules with the profile for library click, pytest, arch-business-logic, arch-ui, arch-unknown
...
- **Skills**: uv_package_manager, core_components, javascript_testing_patterns, notebooklm, loki_mode
...
**Objectives**:
- Read .agent/project_profile.yaml and .agent/context/project-context.md before taking action.
- Confirm the project stage, app type, frameworks, and priorities for goal: align project instructions and rules with the profile for library click, pytest, arch-business-logic, arch-ui, arch-unknown.
- Top relevant skills: uv_package_manager, core_components, javascript_testing_patterns, notebooklm, loki_mode.
...
10. Load the top relevant skills: uv_package_manager, core_components, javascript_testing_patterns, notebooklm, loki_mode.
