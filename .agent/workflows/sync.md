...
- **Goal**: sync local configuration and skills for library click, pytest, arch-business-logic, arch-ui, arch-unknown
...
- **Skills**: hugging_face_jobs, makepad_skills, notebooklm, temporal_python_testing, javascript_testing_patterns
...
**Objectives**:
- Read .agent/project_profile.yaml and .agent/context/project-context.md before taking action.
- Confirm the project stage, app type, frameworks, and priorities for goal: sync local configuration and skills for library click, pytest, arch-business-logic, arch-ui, arch-unknown.
- Top relevant skills: hugging_face_jobs, makepad_skills, notebooklm, temporal_python_testing, javascript_testing_patterns.
...
10. Load the top relevant skills: hugging_face_jobs, makepad_skills, notebooklm, temporal_python_testing, javascript_testing_patterns.
