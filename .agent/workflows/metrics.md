...
**Objectives**:
- Read .agent/project_profile.yaml and .agent/context/project-context.md before taking action.
- Confirm the project stage, app type, frameworks, and priorities for goal: analyze skill quality and usage metrics for library click, pytest, arch-business-logic, arch-ui, arch-unknown.
- Top relevant skills: notebooklm, javascript_testing_patterns, makepad_skills, zapier_make_patterns, prompt_library.
...
10. Load the top relevant skills: notebooklm, javascript_testing_patterns, makepad_skills, zapier_make_patterns, prompt_library.
