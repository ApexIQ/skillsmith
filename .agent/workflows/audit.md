...
- **Goal**: perform security and performance audit for library click, pytest, arch-business-logic, arch-ui, arch-unknown
...
- **Skills**: notebooklm, loki_mode, javascript_testing_patterns, makepad_skills, reverse_engineer
...
**Objectives**:
- Read .agent/project_profile.yaml and .agent/context/project-context.md before taking action.
- Confirm the project stage, app type, frameworks, and priorities for goal: perform security and performance audit for library click, pytest, arch-business-logic, arch-ui, arch-unknown.
- Top relevant skills: notebooklm, loki_mode, javascript_testing_patterns, makepad_skills, reverse_engineer.
...
### Review
> Inspect the changed files for correctness, regressions, and release risks.
...
**Acceptance Checks**:
- [ ] Findings are ordered by severity when issues are present.
...
10. Load the top relevant skills: notebooklm, loki_mode, javascript_testing_patterns, makepad_skills, reverse_engineer.
