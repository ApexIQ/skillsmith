...
- **Goal**: generate a progress and readiness report for library click, pytest, arch-business-logic, arch-ui, arch-unknown
...
- **Skills**: notebooklm, loki_mode, javascript_testing_patterns, makepad_skills, git_pr_workflows_git_workflow
...
**Objectives**:
- Read .agent/project_profile.yaml and .agent/context/project-context.md before taking action.
- Confirm the project stage, app type, frameworks, and priorities for goal: generate a progress and readiness report for library click, pytest, arch-business-logic, arch-ui, arch-unknown.
- Top relevant skills: notebooklm, loki_mode, javascript_testing_patterns, makepad_skills, git_pr_workflows_git_workflow.
...
10. Load the top relevant skills: notebooklm, loki_mode, javascript_testing_patterns, makepad_skills, git_pr_workflows_git_workflow.
